...
.\gradlew.bat assembleRelease 2>&1 | Tee-Object 'C:\Users\user\Desktop\build-171.log'
$apk = 'C:\b\android\app\build\outputs\apk\release\app-release.apk'
if (Test-Path $apk) {
  Copy-Item $apk 'C:\Users\user\Desktop\MyAssistant171.apk' -Force
  'KLAR 171' | Add-Content 'C:\Users\user\Desktop\build-171.log'
} else {
  'MISSLYCKAD' | Add-Content 'C:\Users\user\Desktop\build-171.log'
}
