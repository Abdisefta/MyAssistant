# Prefetch image-picker Maven artifacts (works when Java/Gradle SSL fails).
param(
...
Enqueue 'com.vanniktech' 'android-image-cropper' '4.6.0' 'aar'
Enqueue 'androidx.activity' 'activity' '1.10.0' 'aar'
Enqueue 'androidx.activity' 'activity-ktx' '1.10.0' 'aar'
Enqueue 'host.exp.exponent' 'expo.modules.imagepicker' '16.1.4' 'aar'
