...
New-Item -ItemType Directory -Force -Path $codegen | Out-Null
$env:GRADLE_USER_HOME = 'C:\g'
Set-Location 'C:\b\android'
.\gradlew.bat --stop 2>&1 | Out-Null
.\gradlew.bat assembleRelease 2>&1 | Tee-Object 'C:\Users\user\Desktop\build-155.log'
$apk = 'C:\b\android\app\build\outputs\apk\release\app-release.apk'
if (Test-Path $apk) {
  Copy-Item $apk 'C:\Users\user\Desktop\MyAssistant155.apk' -Force
  'KLAR' | Add-Content 'C:\Users\user\Desktop\build-155.log'
} else {
  'MISSLYCKAD' | Add-Content 'C:\Users\user\Desktop\build-155.log'
}
