...
$gradle = $gradle -replace 'versionName\s+"[^"]+"', 'versionName "1.8.6"'
...
if ($buildOk -and (Test-Path $apk)) {
  Copy-Item $apk 'C:\Users\user\Desktop\MyAssistant186.apk' -Force
  Write-Host 'KLAR: C:\Users\user\Desktop\MyAssistant186.apk'
} else {
  Write-Host 'BYGG MISSLYCKADES — se C:\b\build-186.log'
}
